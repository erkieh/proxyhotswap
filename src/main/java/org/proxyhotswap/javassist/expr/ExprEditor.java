 ...
 *
 * @see org.proxyhotswap.javassist.CtClass#instrument(ExprEditor)
 * @see org.proxyhotswap.javassist.CtMethod#instrument(ExprEditor)
 * @see org.proxyhotswap.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
