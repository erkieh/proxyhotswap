...
package org.proxyhotswap.javassist;
...
import org.proxyhotswap.javassist.bytecode.AccessFlag;
import org.proxyhotswap.javassist.bytecode.AnnotationsAttribute;
import org.proxyhotswap.javassist.bytecode.AttributeInfo;
import org.proxyhotswap.javassist.bytecode.BadBytecode;
import org.proxyhotswap.javassist.bytecode.Bytecode;
import org.proxyhotswap.javassist.bytecode.ClassFile;
...
import org.proxyhotswap.javassist.bytecode.ConstantAttribute;
import org.proxyhotswap.javassist.bytecode.Descriptor;
import org.proxyhotswap.javassist.bytecode.EnclosingMethodAttribute;
import org.proxyhotswap.javassist.bytecode.FieldInfo;
import org.proxyhotswap.javassist.bytecode.InnerClassesAttribute;
import org.proxyhotswap.javassist.bytecode.MethodInfo;
import org.proxyhotswap.javassist.bytecode.ParameterAnnotationsAttribute;
import org.proxyhotswap.javassist.bytecode.SignatureAttribute;
import org.proxyhotswap.javassist.bytecode.annotation.Annotation;
import org.proxyhotswap.javassist.compiler.AccessorMaker;
import org.proxyhotswap.javassist.compiler.CompileError;
import org.proxyhotswap.javassist.compiler.Javac;
import org.proxyhotswap.javassist.expr.ExprEditor;
...
class CtClassType extends CtClass {
   ...
   /**
    ...
    /**
     * @see org.proxyhotswap.javassist.CtClass#prune()
     * @see org.proxyhotswap.javassist.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
