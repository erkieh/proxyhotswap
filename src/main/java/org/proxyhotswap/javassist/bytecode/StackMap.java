...
import org.proxyhotswap.javassist.bytecode.StackMapTable.InsertLocal;
import org.proxyhotswap.javassist.bytecode.StackMapTable.NewRemover;
import org.proxyhotswap.javassist.bytecode.StackMapTable.Shifter;
...
public class StackMap extends AttributeInfo {
     ...
     *
     * @see org.proxyhotswap.javassist.CtBehavior#addParameter(org.proxyhotswap.javassist.CtClass)
