...
import org.proxyhotswap.javassist.bytecode.*;
import org.proxyhotswap.javassist.compiler.CompileError;
import org.proxyhotswap.javassist.compiler.Javac;
import org.proxyhotswap.javassist.compiler.SymbolTable;
import org.proxyhotswap.javassist.compiler.ast.ASTree;
import org.proxyhotswap.javassist.compiler.ast.DoubleConst;
import org.proxyhotswap.javassist.compiler.ast.IntConst;
import org.proxyhotswap.javassist.compiler.ast.StringL;
...
public class CtField extends CtMember {
     ...
     * It represents a type including type variables.
     * See {@link org.proxyhotswap.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see org.proxyhotswap.javassist.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
     ...
     * See {@link org.proxyhotswap.javassist.bytecode.AttributeInfo}.
     *
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see org.proxyhotswap.javassist.CtField.Initializer#byNewArray(CtClass,int)
         * @see org.proxyhotswap.javassist.CtField.Initializer#byNewArray(CtClass,int[])
         */
