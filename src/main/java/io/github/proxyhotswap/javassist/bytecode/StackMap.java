...
import io.github.proxyhotswap.javassist.bytecode.StackMapTable.InsertLocal;
import io.github.proxyhotswap.javassist.bytecode.StackMapTable.NewRemover;
import io.github.proxyhotswap.javassist.bytecode.StackMapTable.Shifter;
...
public class StackMap extends AttributeInfo {
     ...
     *
     * @see io.github.proxyhotswap.javassist.CtBehavior#addParameter(io.github.proxyhotswap.javassist.CtClass)
