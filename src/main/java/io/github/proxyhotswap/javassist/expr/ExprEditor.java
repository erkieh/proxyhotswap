 ...
 *
 * @see io.github.proxyhotswap.javassist.CtClass#instrument(ExprEditor)
 * @see io.github.proxyhotswap.javassist.CtMethod#instrument(ExprEditor)
 * @see io.github.proxyhotswap.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
