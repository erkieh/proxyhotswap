...
package io.github.proxyhotswap.javassist.tools.rmi;
...
public class StubGenerator implements Translator {
     ...
     *
     * @see io.github.proxyhotswap.javassist.Translator#start(ClassPool)
     */
     ...
     * Does nothing.
     * This is a method declared in javassist.Translator.
     * @see io.github.proxyhotswap.javassist.Translator#onLoad(ClassPool,String)
     */
