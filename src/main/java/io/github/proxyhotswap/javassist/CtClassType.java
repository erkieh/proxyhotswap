...
package io.github.proxyhotswap.javassist;

import io.github.proxyhotswap.javassist.bytecode.AccessFlag;
import io.github.proxyhotswap.javassist.bytecode.AnnotationsAttribute;
import io.github.proxyhotswap.javassist.bytecode.AttributeInfo;
import io.github.proxyhotswap.javassist.bytecode.BadBytecode;
import io.github.proxyhotswap.javassist.bytecode.Bytecode;
import io.github.proxyhotswap.javassist.bytecode.ClassFile;
import io.github.proxyhotswap.javassist.bytecode.CodeAttribute;
import io.github.proxyhotswap.javassist.bytecode.CodeIterator;
import io.github.proxyhotswap.javassist.bytecode.ConstPool;
import io.github.proxyhotswap.javassist.bytecode.ConstantAttribute;
import io.github.proxyhotswap.javassist.bytecode.Descriptor;
import io.github.proxyhotswap.javassist.bytecode.EnclosingMethodAttribute;
import io.github.proxyhotswap.javassist.bytecode.FieldInfo;
import io.github.proxyhotswap.javassist.bytecode.InnerClassesAttribute;
import io.github.proxyhotswap.javassist.bytecode.MethodInfo;
import io.github.proxyhotswap.javassist.bytecode.ParameterAnnotationsAttribute;
import io.github.proxyhotswap.javassist.bytecode.SignatureAttribute;
import io.github.proxyhotswap.javassist.bytecode.annotation.Annotation;
import io.github.proxyhotswap.javassist.compiler.AccessorMaker;
import io.github.proxyhotswap.javassist.compiler.CompileError;
import io.github.proxyhotswap.javassist.compiler.Javac;
import io.github.proxyhotswap.javassist.expr.ExprEditor;
...
class CtClassType extends CtClass {
   ...
   /**
    ...
    /**
     * @see io.github.proxyhotswap.javassist.CtClass#prune()
     * @see io.github.proxyhotswap.javassist.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
