...
public abstract class CtMember {
     ...
     *
     * @see io.github.proxyhotswap.javassist.bytecode.SignatureAttribute#toFieldSignature(String)
     * @see io.github.proxyhotswap.javassist.bytecode.SignatureAttribute#toMethodSignature(String)
