...
import io.github.proxyhotswap.javassist.bytecode.*;
import io.github.proxyhotswap.javassist.compiler.CompileError;
import io.github.proxyhotswap.javassist.compiler.Javac;
import io.github.proxyhotswap.javassist.compiler.SymbolTable;
import io.github.proxyhotswap.javassist.compiler.ast.ASTree;
import io.github.proxyhotswap.javassist.compiler.ast.DoubleConst;
import io.github.proxyhotswap.javassist.compiler.ast.IntConst;
import io.github.proxyhotswap.javassist.compiler.ast.StringL;
...
public class CtField extends CtMember {
     ...
     * It represents a type including type variables.
     * See {@link io.github.proxyhotswap.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see io.github.proxyhotswap.javassist.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
     ...
     * See {@link io.github.proxyhotswap.javassist.bytecode.AttributeInfo}.
     *
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see io.github.proxyhotswap.javassist.CtField.Initializer#byNewArray(CtClass,int)
         * @see io.github.proxyhotswap.javassist.CtField.Initializer#byNewArray(CtClass,int[])
         */
