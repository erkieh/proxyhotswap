 ...
 *
 * @see io.github.proxyhotswap.javassist.CtClass
 * @see io.github.proxyhotswap.javassist.ClassPath
 */
public class ClassPool {
     ...
     * @see io.github.proxyhotswap.javassist.ClassPool#getDefault()
     */
     ...
     * @see #get(String)
     * @see io.github.proxyhotswap.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see io.github.proxyhotswap.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see io.github.proxyhotswap.javassist.ByteArrayClassPath
     */
     ...
     * @see io.github.proxyhotswap.javassist.ClassPath
     * @see io.github.proxyhotswap.javassist.URLClassPath
     * @see io.github.proxyhotswap.javassist.ByteArrayClassPath
     */
